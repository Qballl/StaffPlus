...
public class StaffPlus extends JavaPlugin implements IStaffPlus {
    ...
    protected void start(long start) {
        ...
        message.sendConsoleMessage("Plugin created by Shortninja continued by Qball, retrofitted by Mocha.", false);
    }
    ...
    private void checkUpdate() {
        getLogger().info("Auto Update has been disabled my Mocha");
    }
